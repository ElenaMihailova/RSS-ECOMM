  ...
  <div class="container">
    ...
    <ul class="blog__list">
      <li class="blog__item article">
        <img class="article__img" src="./image/steep.png" width="172" height="273" alt="STEEP TEA" />
        <div class="article__description">
          <h3 class="titleMonserrat titleMonserrat--big">
            HOW TO STEEP TEA LIKE A PRO
          </h3>
          <p class="article__text">
            To&nbsp;brew tea like a&nbsp;pro, it&rsquo;s important to&nbsp;consider the right tea to&nbsp;water ratio
      ...
      <li class="blog__item article article--reverse">
        <img class="article__img" src="./image/tea.png" width="172" height="273" alt="STEEP TEA" />
        <div class="article__description">
          <h3 class="titleMonserrat titleMonserrat--big">
            ALL ABOUT TEA AROMAS
          </h3>
          <p class="article__text">
            Each tea has a&nbsp;unique aroma that is&nbsp;revealed when brewed properly and can tell us&nbsp;about the
